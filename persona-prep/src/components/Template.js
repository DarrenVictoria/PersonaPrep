...
<div className="formtemp-page">
            <div className="formtemp-header-container">
                ...
                <div className="formtemp-variable">
                    ...
                    {
                        (currentPageIndex === 15) && <p className="formtemp-variablename">Project Experience 3/3</p>
                    }
                    {
                        (currentPageIndex === 16) && <p className="formtemp-variablename">summary1</p>
                    }
                    {
                        (currentPageIndex === 17) && <p className="formtemp-variablename">summary2</p>
                    }
                ...
                <Grid container spacing={2}>
                    ...
                    <form style={{height: '100%', position: 'relative'}}>
                        <div style={{marginBottom: '75px'}}>
                            ...
                            {
                                (currentPageIndex === 15) && <Projects_3></Projects_3>
                            }
                            {
                                (currentPageIndex === 16) && <Summary_2></Summary_2>
                            }
                            {
                                (currentPageIndex === 17) && <Summary_1></Summary_1>
                            }
